...
//  youtube
//
//  Created by Ima Miri on 30/11/18.
...
class VideoPlayerView: UIView {
    ...
    private func setupPlayerView(){
        // warning: use your own video link here, the bandwidth for google firebase storage will run out as more and more people use this file
        ...
        if let url = NSURL(string: urlString) {
            ...
            player?.addPeriodicTimeObserver(forInterval: interval, queue: .main, using: {(progressTime) in
                ...
                self.currentTimeLabel.text = "00:\(secondsString)"
